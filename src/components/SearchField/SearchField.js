...
class SearchField extends React.Component {
    ...
    render(){
        ...
        const isDisabled = this.props.state.dataSearch ? '' : 'search-field__button--disabled';
        ...
        return(
            <div className="search-field">
                <div className="search-field__wrap">
                    ...
                    <button className={`search-field__button ${isDisabled}`} onClick={this.props.onClick} >Search</button>
                </div>
            </div>
        )
    }
