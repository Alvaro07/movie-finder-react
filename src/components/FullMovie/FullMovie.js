            ...
            return(
                <div className="full-movie">
                    ...
                    <div className="full-movie__content">
                        <h2 className="full-movie__title">{this.props.state.fullContent.Title} <span>({this.props.state.fullContent.Year})</span></h2>


                        <ul className="full-movie__entry-list">
                            <li>{this.props.state.fullContent.Runtime}</li>
                            <li>{this.props.state.fullContent.Released}, {this.props.state.fullContent.Country}</li>
                            <li>{this.props.state.fullContent.Genre}</li>
                        </ul>

                        <p className="full-movie__description">{this.props.state.fullContent.Plot}</p>
